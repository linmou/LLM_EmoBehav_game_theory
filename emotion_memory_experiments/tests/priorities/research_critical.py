...
class TestScientificInvariants:
    ...
    def test_evaluation_determinism(self):
        ...
        for response, ground_truth, task_type in test_cases:
            ...
            for _ in range(5):
                ...
                with patch('emotion_memory_experiments.evaluation_utils.llm_evaluate_response') as mock_eval:
    ...
    def test_llm_evaluation_consistency(self):
        ...
        for hierarchy in test_hierarchies:
            ...
            with patch('emotion_memory_experiments.evaluation_utils.llm_evaluate_response', side_effect=mock_eval):
