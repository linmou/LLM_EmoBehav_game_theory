...
from emotion_memory_experiments.evaluation_utils import llm_evaluate_response, llm_evaluate_batch
...
class TestDatasetFactoryAPICompatibility:
    ...
    @patch('emotion_memory_experiments.datasets.base.BaseBenchmarkDataset._load_raw_data')
...
class TestBaseBenchmarkDatasetInterface:
    ...
    def test_evaluate_response_signature_stability(self):
        ...
        from emotion_memory_experiments.datasets import infinitebench, longbench, locomo, emotion_check
...
class TestVersionCompatibilityMatrix:
    ...
    def test_import_stability(self):
        ...
        try:
            # Core functionality
            from emotion_memory_experiments import experiment, dataset_factory, data_models
            from emotion_memory_experiments.datasets import base, infinitebench, longbench, locomo
            from emotion_memory_experiments import evaluation_utils, config_loader
            
            # Test the new file mentioned by user
            from emotion_memory_experiments.tests import test_answer_wrapper_comprehensive
            
        except ImportError as e:
            pytest.fail(f"Import regression detected: {str(e)}")
    
    @patch('emotion_memory_experiments.evaluation_utils.openai')
