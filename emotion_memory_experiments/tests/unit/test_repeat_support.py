...
- emotion_memory_experiments/run_emotion_memory_experiment.py
- emotion_memory_experiments/memory_experiment_series_runner.py
"""
...
from emotion_memory_experiments.run_emotion_memory_experiment import run_experiment
...
def test_repeat_aggregation_and_readme():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("neuro_manipulation.utils.load_tokenizer_only", return_value=(_make_dummy_tokenizer(), None)), \
             patch("emotion_memory_experiments.experiment.create_benchmark_components", return_value=(None, None, [])), \
...
def test_cli_passes_repeat_runs_and_seed_to_experiment(tmp_path: Path):
    ...
    with patch("emotion_memory_experiments.experiment.EmotionExperiment", DummyExperiment):
...
def test_series_runner_passes_repeat_and_seed(tmp_path: Path):
    ...
    with patch("emotion_memory_experiments.experiment.EmotionExperiment", DummyExp):
