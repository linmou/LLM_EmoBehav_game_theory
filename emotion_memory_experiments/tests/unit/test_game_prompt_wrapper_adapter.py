# Tests for emotion_memory_experiments/game_prompt_wrapper.py
...
from emotion_memory_experiments.game_prompt_wrapper import GameBenchmarkPromptWrapper
...
def patch_game_config(monkeypatch):
    ...
    monkeypatch.setattr(
        "emotion_memory_experiments.game_prompt_wrapper.get_game_config",
...
def prompt_wrapper(monkeypatch) -> GameBenchmarkPromptWrapper:
    ...
    monkeypatch.setattr(
        "emotion_memory_experiments.game_prompt_wrapper.GameReactPromptWrapper",
