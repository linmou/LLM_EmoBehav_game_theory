...
Responsible files:
- emotion_memory_experiments/benchmark_component_registry.py
- emotion_memory_experiments/datasets/fantom.py (to be implemented)
...
from emotion_memory_experiments.fantom_prompt_wrapper import FantomPromptWrapper
