...
Covers: emotion_memory_experiments/experiment.py
...
def test_eval_error_is_propagated_to_results(tmp_path: Path):
    ...
    fake_registry_module = type(sys)("emotion_memory_experiments.benchmark_component_registry")
    ...
    sys.modules["emotion_memory_experiments.benchmark_component_registry"] = fake_registry_module

    # Import after stubbing to avoid import-time errors
    experiment_module = importlib.import_module("emotion_memory_experiments.experiment")
