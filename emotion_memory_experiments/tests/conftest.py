...
from emotion_memory_experiments.data_models import BenchmarkConfig, ExperimentConfig, BenchmarkItem
...
def mock_neural_components():
    ...
    with patch('emotion_memory_experiments.experiment.load_emotion_readers') as mock_readers, \
         patch('emotion_memory_experiments.experiment.setup_model_and_tokenizer') as mock_setup, \
         patch('emotion_memory_experiments.experiment.get_pipeline') as mock_pipeline:
