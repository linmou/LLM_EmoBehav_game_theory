...
class TestEndToEndIntegration(unittest.TestCase):
    ...
    def test_mtbench101_end_to_end_integration(self):
        ...
        with patch(
            "emotion_memory_experiments.datasets.mtbench101.llm_evaluate_response"
        ) as mock_llm:
    ...
    def _get_mock_path_for_benchmark(self, benchmark_name):
        ...
        mock_paths = {
            'mtbench101': 'emotion_memory_experiments.datasets.mtbench101.llm_evaluate_response',
            'longbench': 'emotion_memory_experiments.evaluation_utils.llm_evaluate_response',
            'infinitebench': 'emotion_memory_experiments.evaluation_utils.llm_evaluate_response', 
            'locomo': 'emotion_memory_experiments.evaluation_utils.llm_evaluate_response'
        }
        return mock_paths.get(benchmark_name, 'emotion_memory_experiments.evaluation_utils.llm_evaluate_response')
    ...
    def test_longbench_end_to_end_integration(self):
        ...
        with patch(
            "emotion_memory_experiments.evaluation_utils.llm_evaluate_response"
        ) as mock_llm:
    ...
    def test_real_prompt_wrapper_integration_with_experiment_flow(self):
        ...
        with patch('emotion_memory_experiments.datasets.mtbench101.llm_evaluate_response') as mock_llm:
