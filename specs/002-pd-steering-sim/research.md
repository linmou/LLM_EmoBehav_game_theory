...
- Hidden state capture is currently a placeholder; pipeline allows injection but does not yet connect to vLLM hooks.
- Emotion rankings are based on switcher group summaries only; additional grouping or weighting may be needed for broader analyses.
