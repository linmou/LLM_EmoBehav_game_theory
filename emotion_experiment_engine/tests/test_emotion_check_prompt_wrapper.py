...
- System: sets questionnaire persona and instructions
...
class TestEmotionCheckPromptFormat(unittest.TestCase):
    def test_emotion_check_moves_question_to_user(self):
        ...
        # System prompt should set questionnaire persona and NOT include the question
        self.assertIn("psychological questionnaire", prompt_format.last_system_prompt)
        ...
        self.assertIn("'response'", prompt_format.last_user_messages[0])
