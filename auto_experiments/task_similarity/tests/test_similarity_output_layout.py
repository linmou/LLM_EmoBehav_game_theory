...
def test_build_output_dir_layout():
    ...
    out = build_output_dir(
        output_root=Path("auto_experiments/task_similarity/results/anger_pd_delta_similarity"),
    ...
    assert out.as_posix().endswith(
        "auto_experiments/task_similarity/results/anger_pd_delta_similarity/20260102_135547/"
