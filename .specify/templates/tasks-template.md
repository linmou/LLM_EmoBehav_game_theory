...
- [ ] TXXX [P] README or `claude_doc` updates for changed behavior/contracts
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run mypy for modified Python files
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Verify run metadata, logs, or output evidence for research-facing changes
