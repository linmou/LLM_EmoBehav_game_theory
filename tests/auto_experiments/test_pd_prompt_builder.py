...
def test_pair_labels_defect_first():
    ...
    assert pair.positive.endswith("Assistant: A")
    assert pair.negative.endswith("Assistant: B")
    assert "Imagine you are Alice" in pair.positive
...
def test_pair_labels_cooperate_first():
    ...
    assert pair.positive.endswith("Assistant: B")
    assert pair.negative.endswith("Assistant: A")
