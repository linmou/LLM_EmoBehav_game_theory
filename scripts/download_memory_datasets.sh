...
if [[ $exit_code -eq 0 ]]; then
    ...
    echo ""
    echo "Next steps:"
    echo "1. Run tests: python emotion_experiment_engine/tests/run_all_tests.py"
    echo "2. Or run individual tests:"
    echo "   - python emotion_experiment_engine/tests/test_real_data_comprehensive.py"
    echo "   - python emotion_experiment_engine/tests/test_original_evaluation_metrics.py"
    echo ""
